    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnCalculate_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (!isA1Parsed || !isB1Parsed || !isC1Parsed 
                    || !isA2Parsed || !isB2Parsed || !isC2Parsed)
                {
                ...
                else
                {
                    perimeter = tri1;
                    area = -tri1;
                    lblResult11.Text = "Периметр 1 треугольника = " 
                                       + perimeter.ToString("F2");
                    lblResult11.Foreground = Brushes.Black;
                    lblResult12.Text = "Площадь 1 треугольника = " 
                                       + area.ToString("F2");
                ...
                else
                {
                    perimeter = tri2;
                    area = -tri2;
                    lblResult21.Text = "Периметр 2 треугольника = " 
                                       + perimeter.ToString("F2");
                    lblResult21.Foreground = Brushes.Black;
                    lblResult22.Text = "Площадь 2 треугольника = " 
                                       + area.ToString("F2");
